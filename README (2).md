...
<img width="600" alt="All users in the Lainecorp tenant" src="01-tenant-all-users.png">
...
<img width="600" alt="Human Resources group members" src="02-group-human-resources.png">

<img width="600" alt="Information Technology group members" src="03-group-information-technology.png">

<img width="600" alt="Sales group members" src="04-group-sales.png">
...
<img width="600" alt="E5 subscriptions active on the tenant" src="05-licenses-products.png">
...
<img width="600" alt="Group-based license assignment in the Microsoft 365 admin center" src="06-license-group-assignment.png">
...
<img width="600" alt="Conditional Access policy enforcing MFA" src="07-conditional-access-mfa.png">
...
<img width="600" alt="Break-glass emergency admin account" src="08-breakglass-admin.png">
...
<img width="600" alt="SSPR enabled for all users" src="09-sspr-enabled-all.png">
...
<img width="600" alt="SSPR requiring two authentication methods" src="10-sspr-auth-methods.png">
...
<img width="600" alt="Helpdesk Administrator role assigned to Zendaya Coleman" src="11-helpdesk-admin-delegation.png">
...
<img width="600" alt="Successful delegated password reset as Helpdesk Administrator" src="12-delegated-reset-success.png">
...
<img width="600" alt="401 error on the resource-scoped Password reset blade" src="13-delegated-reset-401.png">
...
<img width="600" alt="Kyle Lowry selected in the All users list" src="14-incident-user-selected.png">
...
<img width="600" alt="Disabling the compromised account" src="15-incident-disable-account.png">
...
<img width="600" alt="Revoking sessions on the disabled account" src="16-incident-revoke-sessions.png">
...
<img width="600" alt="Lockout message shown to the end user" src="17-incident-lockout-message.png">
...
<img width="600" alt="Sign-in logs showing failures after containment" src="18-incident-signin-logs.png">
...
<img width="600" alt="Requiring MFA re-registration" src="19-incident-mfa-reregistration.png">
...
<img width="600" alt="Identity verification prompt on sign-in" src="20-incident-verify-password.png">

<img width="600" alt="Microsoft Authenticator QR re-registration" src="21-incident-authenticator-qr.png">
